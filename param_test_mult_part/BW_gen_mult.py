...
for dn in range(0,len(Delta_num)):
  for fn in range(0,len(Free_num)):
    ...
    for Ai in A:
      ...
      x,y,fwhm,mxi=generator(Delta_num[dn],Free_num[fn],filename,DT=delta_temp,A=Ai,output_folder=output_folderA)
      xlistA.append(x)
      ylistA.append(y)
    ...
    for bi in b:
      ...
      x,y,fwhm,mxi=generator(Delta_num[dn],Free_num[fn],filename,DT=delta_temp,b=bi,output_folder=output_folderb)
      xlistb.append(x)
      ylistb.append(y)
