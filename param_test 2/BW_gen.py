...
for Ai in A:
  ...
  x,y,fwhm,mxi=generator(Delta_num[1],Free_num[0],filename,DT=delta_temp,A=Ai,output_folder=output_folderA)
  xlistA.append(x)
  ylistA.append(y)
...
for bi in b:
  ...
  x,y,fwhm,mxi=generator(Delta_num[1],Free_num[0],filename,DT=delta_temp,b=bi,output_folder=output_folderb)
  xlistb.append(x)
  ylistb.append(y)
