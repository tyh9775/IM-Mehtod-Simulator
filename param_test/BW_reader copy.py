...
#for comparing different widths
  ...
  for filename in glob.glob(os.path.join(directory,file_pattern)):
    ...
    a_ac.append(popt_act[1])
    b_ac.append(popt_act[2])
    ...
    a_cr.append(popt_cr[1])
    b_cr.append(popt_cr[2])
  ...
  return IM_all,act_all,cr_all,mnt_all,a_rec,b_rec,a_ac,b_ac,a_cr,b_cr
...
i1,a1,c1,mn1,a_rec,b_rec,a_ac,b_ac,a_cr,b_cr=reader(directorya,file_patterna,graph_foldera)
i2,a2,c2,mn2,a_rec2,b_rec2,a_ac2,b_ac2,a_cr2,b_cr2=reader(directoryb,file_patternb,graph_folderb)

print(a_rec)
print(b_rec)
print(a_rec2)
print(b_rec2)
print(np.corrcoef(a_rec,b_rec))
print(np.corrcoef(a_rec2,b_rec2))